...
- [ ] **PAGE-01**: Главная (`/`): Hero с CTA, блок «Почему иногородним», 3 ключевые услуги (превью), 3 свежих кейса, форма, блок доверия (логотипы клиентов, реквизиты ИП)
...
- [ ] **PAGE-13**: Витрина кейсов (`/cases/`) с превью минимум 5 кейсов
- [ ] **PAGE-14**: Детальная страница кейса × 5 (Быстринское, ВКЛЮЧИ, ДОМ, Нити дочерей ночи + один свежий), ≥ 600 слов на кейс
