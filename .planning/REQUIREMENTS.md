...
- [ ] **AUDIT-01**: Проведён полный технический SEO-аудит крылья.life (индексация, on-page title/description/H1-H3/alt/canonical, скорость и Core Web Vitals, sitemap, robots, разметка JSON-LD + микроразметка, внутренняя перелинковка, битые ссылки) с чек-листом исправлений по приоритету
- [ ] **AUDIT-02**: Проверена и исправлена корректность Яндекс.Метрики (счётчик, цель «отправка формы», вебвизор, фильтрация собственного трафика, отсутствие дубля счётчиков)
...
- [ ] **AUDIT-05**: Критические технические и on-page ошибки из аудита исправлены на сайте и проверены
...
- [ ] **TREND-03**: Сформулировано, чем «Крылья» могут ярко выделиться сегодня (применимые к бренду тренды)
- [ ] **TREND-04**: Заложен регулярный процесс мониторинга трендов (что и где смотреть, с какой частотой)

### FORMAT — Линейка форматов мероприятий

- [ ] **FORMAT-01**: Разработана и упакована линейка из 10+ форматов мероприятий под сегменты (девелоперы, крупный бизнес, иногородние/федеральные)
- [ ] **FORMAT-02**: По каждому формату описано: для кого, что внутри, чем цепляет, почему именно «Крылья»
- [ ] **FORMAT-03**: Выделены форматы под иногородних/федеральных клиентов, проводящих мероприятия в Калининграде (упор на локальную аутентику и логистику)
...
- [ ] **HUB-02**: Принято и зафиксировано решение по технологии контент-хаба (нативный Astro Content Collection в подпапке `/идеи/`, не внешний SaaS)
- [ ] **HUB-03**: Реализован раздел блога/«Идеи» на сайте: коллекция с Zod-схемой, шаблон статьи, витрина, перелинковка на услуги и кейсы, sitemap, JSON-LD Article + BreadcrumbList, RSS
