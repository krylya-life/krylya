...
- [ ] **COMP-01**: Собраны досье 10–15 топовых мировых ивент-агентств (Европа / Америка / Азия): позиционирование, структура сайта, SEO-подход, SMM, сигнатурные форматы, визуальный язык — с выводом «что украсть / что не повторять»
