...
- [x] **HUB-01**: Собрано и кластеризовано расширенное семантическое ядро под сегмент C + новые кластеры (форматы, отрасли, информационные запросы) с распределением интентов (защита от каннибализации с коммерческими страницами)
- [x] **HUB-02
...
- [x] **HUB-04**: Составлен рубрикатор и план из 20–30 тем статей под информационные запросы с привязкой к кластерам ядра
- [x] **HUB-05**: Опубликованы первые стартовые статьи по плану (реалистичный темп ≈ 1 статья/неделю)
...
| HUB-01 | Phase 14 | Done |
| HUB-02 | Phase 14 | Done |
| HUB-03 | Phase 14 | Done |
| HUB-04 | Phase 14 | Done |
| HUB-05 | Phase 14 | Done |
