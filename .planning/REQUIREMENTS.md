...
- [ ] **TREND-01**: Собран отчёт трендов ивент-индустрии 2026 (форматы, технологии, визуал, темы — что сейчас «выстреливает»)
- [ ] **TREND-02**: Собраны тренды SMM-контента ивент-агентств в Instagram и Telegram (форматы reels/stories/постов, подача, что даёт охваты)
