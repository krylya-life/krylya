...
Phase 5 (кейсы) ждёт двух внешних входов: (1) согласия клиентов на публикацию имени и фото с мероприятия, (2) фотоархив с площадок. Решения Маши 2026-05-02:
- Логотипы клиентов в v1 не публикуем (их пока не так много)
- Цитаты-отзывы клиентов в v1 не публикуем
- Бюджеты и конкретные суммы на страницах кейсов не показываем
- Скоуп уменьшен с «ровно 5 кейсов» до «несколько кейсов» (точное число решим в discuss-phase)
- На страницу кейса идёт: имя клиента (с согласия) или отрасль, количество гостей, формат, длительность, фото
- Опционально может появиться отдельный фотоальбом с подборкой фото с разных мероприятий — решим, когда соберётся архив

Когда входы подтянутся — `/gsd-plan-phase 5`.
