...
Phase 5 (кейсы) ждёт двух внешних входов: (1) согласия клиентов на публикацию имени/логотипа/отзыва, (2) фотоархив с площадок. Параллельно — Маша продолжает сбор и переписку с клиентами. Когда оба входа готовы — `/gsd-plan-phase 5` (5 страниц кейсов ≥600 слов + витрина /cases/).
